                                ...
                                <table style="background: #336f85; border: 0px; border-radius: 0px; width: 599px; height: 53px; margin-left: auto; margin-right: auto;"
                                    ...
                                    <tr>
                                        ...
                                        <td class="tw-card-header"
                                            ...
                                            align="center"><span
                                                style="font-weight: 600;">Verifique su
                                                nueva cuenta de Bigdeal</span></td>
                                ...
                                <table dir="ltr" style="border: 0; width: 100%;" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td class="tw-card-body"
                                            ...
                                            <span style="font-weight: 400;">¡Gracias, por unirse a la aplicación <strong>Bigdeal</strong>, donde encuentras de todo para el hogar y al mejor precio!
</span><br/><br/><span
                                                style="font-weight: 400;">Para completar el proceso de registro, Introduzca el siguiente código:</span>
                                                            ...
                                                            <tr>
                                                                <td class="button__td "
                                                                    ...
                                                                    <![endif]--> <!-- [if !mso]><!--> <p
                                                                            ...
                                                                            rel="noopener">${userEmailTokenVerificationLink}</p> <!--![endif]--></td>
                                            ...
                                            <p class=""
                                               style="margin: 20px 0; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;">No comparta este código con nadie, ya que puede brindarles acceso a su cuenta de Amazon.</p>
                                            <p class="tw-signoff"
